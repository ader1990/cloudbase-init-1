...
class ConfigWinRMCertificateAuthPluginTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with (mock.patch('cloudbaseinit.plugins.windows.winrmcertificateauth.'
              ...
              mock.patch('cloudbaseinit.utils.windows.winrmconfig.'
                         'WinRMConfig'),
              mock.patch('cloudbaseinit.utils.windows.x509.'
                         'CryptoAPICertManager.import_cert'),
              mock.patch('cloudbaseinit.osutils.factory.get_os_utils'),
              mock.patch('cloudbaseinit.utils.windows.security.'
                         'WindowsSecurityUtils.set_uac_remote_restrictions'),
              mock.patch('cloudbaseinit.utils.windows.security.'
                         'WindowsSecurityUtils.get_uac_remote_restrictions')):
